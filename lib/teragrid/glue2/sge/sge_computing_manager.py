...
logger = logging.getLogger("SgeComputingManagerAgent")

##############################################################################################################

class SgeComputingManagerAgent(ComputingManagerAgent):
    def __init__(self, args={}):
        ComputingManagerAgent.__init__(self,args)
        self.name = "teragrid.glue2.SgeComputingManager"
...
if __name__ == "__main__":    
    agent = SgeComputingManagerAgent.createFromCommandLine()
