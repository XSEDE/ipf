...
logger = logging.getLogger("LoadLevelerComputingServiceAgent")

##############################################################################################################

class LoadLevelerComputingServiceAgent(ComputingServiceAgent):
    def __init__(self, args={}):
        ComputingServiceAgent.__init__(self,args)
        self.name = "teragrid.glue2.LoadLevelerComputingService"
...
if __name__ == "__main__":    
    agent = LoadLevelerComputingServiceAgent.createFromCommandLine()
