...
class ComputingActivitiesStep(glue2.nimbus.ComputingActivitiesStep):
    def __init__(self):
        glue2.nimbus.ComputingActivitiesStep.__init__(self)

    def _run(self):
        activities = glue2.nimbus.ComputingActivitiesStep._run(self)
...
class ComputingActivityUpdateStep(glue2.nimbus.ComputingActivityUpdateStep):
    def __init__(self):
        glue2.nimbus.ComputingActivityUpdateStep.__init__(self)
