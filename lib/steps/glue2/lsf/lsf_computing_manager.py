...
logger = logging.getLogger("LsfComputingManagerAgent")

##############################################################################################################

class LsfComputingManagerAgent(ComputingManagerAgent):
    def __init__(self, args={}):
        ComputingManagerAgent.__init__(self,args)
        self.name = "teragrid.glue2.LsfComputingManager"
...
if __name__ == "__main__":    
    agent = LsfComputingManagerAgent.createFromCommandLine()
