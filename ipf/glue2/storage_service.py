...
class StorageBaseServiceStep(GlueStep):

    def __init__(self):
        GlueStep.__init__(self)

        self.description = "This step provides a GLUE 2 StorageBaseService document. It is an aggregation mechanism"
        self.time_out = 10
#        self.requires = [ResourceName,Location,ComputingActivities,ComputingShares]
        self.produces = [StorageBaseService]
...
#            share.ServiceID = service.ID
    ...
    def _run(self):
        raise StepError("StorageBaseServiceStep._run not overriden")

#######################################################################################################################

class StorageBaseService(Service):
    def __init__(self):
...
class StorageBaseServiceTeraGridXml(ServiceTeraGridXml):
    data_cls = StorageBaseService
    ...
    def toDom(self):
        doc = getDOMImplementation().createDocument("http://info.teragrid.org/glue/2009/02/spec_2.0_r02",
                                                    "Entities",None)
        root = doc.createElement("StorageBaseService")
...
class StorageBaseServiceOgfJson(ServiceOgfJson):
    data_cls = StorageBaseService
